...
class ClientServiceThread extends Thread {
	 ...
	 * 
	 * @param add
	 *            Strings ref fields represents the register to the system.
	 * @return clientsBank.
	 */
	public synchronized ArrayList<ClientBean> addCLientList(String clientName, String clientAddress,
			String clientACnumber, String clientUserName, String clientPassword) {
	...
	public ArrayList<ClientBean> loadClientsFile() throws FileNotFoundException {
		...
		while (scan.hasNextLine()) {
			...
			clientsBank.add(
					new ClientBean(clientValue[0], clientValue[1], clientValue[2], clientValue[3], clientValue[4]));
		}
	...
	public boolean verifyUser(String clientACnumber, String clientUserName, String clientPassword) {
		...
		for (int i = 0; i < clientsBank.size(); i++) {
			...
			if (clientACnumber.equals(clientsBank.get(i).getClientACnumber())
					&& clientUserName.equals(clientsBank.get(i).getClientUserName())
					&& clientPassword.equals(clientsBank.get(i).getClientPassword())) {
